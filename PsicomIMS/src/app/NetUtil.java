...
public class NetUtil {
	...
	public static String postToUrlThroughProxy(String url, String body) throws Exception
	{
	...
	public static String postToUrl(String url, String body) throws Exception
	{
		DefaultHttpClient httpClient = new DefaultHttpClient();
